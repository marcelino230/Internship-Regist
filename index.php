...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<!-- Brand -->
		<a class="navbar-brand" href="index.php">Hosana Software</a>
	...
	<div class="container-fluid container-fluid1">
		<h4 class="mb-lg-5 pb-5">PKL Di Hosana Software Bogor</h4>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-5 offset-md-1">
				Isilah form dibawah untuk mengisi data lamanya PKL.
			</div>
			<div class="col-md-5">
				Pilihan 3 bulan untuk semester 3, dan 6 bulan untuk semester 7.
			</div>
		</div>
		<br>
	...
	<div id="pendaftar" class="container-fluid pendaftar">
		<div class="container daftar" style="padding-top: 10px;">
			<h3 class="text-center">Formulir Pendaftaran Hosana Software</h3>
			<hr class="col-md-6">
			<div class="row">
				<div class="col-md-6 offset-md-3">
					<form action="" method="post">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="nis" placeholder="NPM" autocomplete="off" name="nis" maxlength="5">
						</div>
						<div class="form-group">
	...
	<div class="container-fluid" style="position: relative; top: 20px;">
		<div class="container">
			<p>Copyright &copy; <?= date("Y"); ?> By Marcelino Okta</p>
		</div>
	</div>
